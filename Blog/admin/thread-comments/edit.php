...
<head>
    ...
    <title>Admin Edit Thread Comment</title>
</head>
...
<body>
    ...
    <div class="admin-wrapper">
        ...
        <div class="admin-content">
            <div class="bnt-group">
                <a href="create.php" class="btn btn-big">Add Comment</a>
                <a href="index.php" class="btn btn-big">Manage Comment</a>
            </div>
            <div class="content">
                <h2 class="page-title">Edit Thread Comment</h2>
                ...
                <form action="edit.php" method="POST">
                    ...
                    <div>
                        <button type="submit" name="update-topic" class="btn btn-submit">Update Comment</button>
                    </div>
                </form>
            </div>
        </div>
