...
INSERT INTO `comments` (`id`, `user_id`, `post_id`, `parent_comment_id`, `body`, `published`, `created_at`, `update_at`) VALUES
(1, 11, 5, 1, '&lt;p&gt;hello everyone&lt;/p&gt;', 1, '2022-04-03 17:46:15', '2022-04-03 17:46:15'),
(2, 11, 6, 1, '&lt;p&gt;useful post&lt;/p&gt;', 1, '2022-04-03 17:47:46', '2022-04-03 17:47:46');
...
INSERT INTO `thread_comments` (`id`, `user_id`, `thread_id`, `parent_comment_id`, `body`, `published`, `created_at`, `update_at`) VALUES
(1, 11, 1, 1, '&lt;p&gt;Thank GOD. yahoo&lt;/p&gt;', 1, '2022-04-03 20:35:34', '2022-04-03 20:35:34');
...
(13, 1, 'joyboy', 'joyboy@gmail.com', '$2y$10$TVggX8RtNakR1CC.ojrvxOl5nt1DH//gY2Cq6AKiZEt0qHMC2zCMG', '2022-03-20 21:51:23');
